...
interface FamilyMember {
  ...
  translations: Record<"en" | "rw", { role: string; relation: string; bio: string }>;
}
  ...
  const members: FamilyMember[] = [
    {
      ...
      translations: {
        ...
        rw: {
          role: "Umubyeyi Mwiza & Inkingi y'Imbaraga",
          relation: "Mama Wanjye Ukundwa",
          bio: "Inkingi y'ubwenge, ubushizi bw'amanga, n'urukundo rutagira umupaka. Inyigisho n'ubuntu bwayo biduha imbaraga zo gukora ibintu byiza cyane."
        }
      }
    },
    {
      ...
      translations: {
        ...
        rw: {
          role: "Inkingi y'Ubufatanye & Umusomyi wa Tech",
          relation: "Umuvandimwe (Brother)",
          bio: "Isoko y'imbaraga, ibitekerezo bifitiye akamaro umuryango n'ubumwe bwacu. Buri gihe aharanira kubaho neza afite intego mpeshyambuto n'icyerekezo kigezweho."
        }
      }
    },
    {
      ...
      translations: {
        ...
        rw: {
          role: "Umujyanama Mwiza & Umufasha mu Buzima",
          relation: "Mushiki Wanjye Mukuru",
          bio: "Imboni nziza y'ubufatanye n'ubwenge buzira amakemwa. Atuyobora mu byemezo byacu n'ihangana rihebuje kandi akazana umucyo mu muryango wacu."
        }
      }
    },
    {
      ...
      translations: {
        ...
        rw: {
          role: "Umucyo n'Ibisingizo & Umutima Mwiza",
          relation: "Mushiki Wanjye Muto",
          bio: "Uzanira umuryango ibyishimo byera, agaseko keza gasusurutsa imitima, n'icyerekezo gihebuje. Ni urumuri ruzamuka rufite igikundiro n'amahirwe menshi mu buzima."
        }
      }
    },
    {
      ...
      translations: {
        ...
        rw: {
          role: "Inshuti n'Inyubako n'Umutekano ejo hazaza",
          relation: "Murandzi wanjye Muto / Petit",
          bio: "Ufite imbaraga nyinshi, agakina mu buryo bunezereye kandi akagira ubwenge bwinshi mu ishuri. Yuzuye amatsiko menshi, ubushizi bw'amanga, n'icyerekezo cy'ejo hazaza."
        }
      }
    }
  ];
    ...
    <section id="family" className="py-24 bg-transparent transition-colors duration-300 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6 md:px-12 relative z-10">
        ...
        <div className="flex flex-col items-center text-center space-y-4 mb-16">
          ...
          >
            <Users size={12} />
            <span>{language === "en" ? "THE HEART OF EAGLE ART" : "UMUTIMA WA EAGLE ART"}</span>
          </motion.div>
          ...
          >
            {language === "en" ? "My Beloved Family" : "Umuryango Wanjye Inkundwakaza"}
          </motion.h2>
          ...
          >
            {language === "en"
              ...
              : "Ibyagezweho byose ntibiza byonyine. Menya inkingi za mwamba z'urukundo, ubufatanye, n'ibyishimo bituma NDAYISHIMIYE Jean de Dieu akora akazi no kubaka ikoranabuhanga buri munsi."}
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto items-stretch">
          {members.map((member, idx) => {
            const localized = member.translations[language];
        ...
        >
          ...
          <p className="text-sm font-medium tracking-wide text-indigo-800 dark:text-indigo-300 font-serif italic text-center">
            {language === "en"
              ...
              : '"Umuryango si ikintu cy\'ingorabahizi gusa. Ni byose mu buzima. Buri gihe dushyize hamwe, dutera imbere nk\'umuntu umwe."'}
          </p>
          <span className="block mt-2 text-[10px] font-mono font-bold tracking-widest text-indigo-600 dark:text-indigo-400 uppercase">
            {language === "en" ? "Designed with Love by EAGLE ART" : "Byashushanyijwe n'Urukundo na EAGLE ART"}
          </span>
        </motion.div>
      </div>
    </section>
